...
const String kSinglePlayerLabel = 'Single player';
const String kMultiPlayerLabel = 'Multiplayer';
const IconData kSinglePlayerIcon = Icons.person;
const IconData kMultiPlayerIcon = Icons.group;

const String kWinSymbol = '[SYMBOL]';
const String kDialogTitleWinner = '$kWinSymbol won!';
